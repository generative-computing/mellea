...
class ChatContext(Context):
    ...
    def add(self, c: NodeData) -> ChatContext:
    ...
    def view_for_generation(self) -> list[NodeData] | None:
        ...
        Returns:
            list[NodeData] | None: Ordered list of
    ...
    def _as_list_token_budget(self, token_budget: int) -> list[NodeData]:
