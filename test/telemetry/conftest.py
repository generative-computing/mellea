...
def reset_metrics_state() -> None:
    ...
    metrics._adapter_function_invocations_counter = None
    metrics._adapter_function_phase_duration_histogram = None
    metrics._adapter_function_parse_failures_counter = None
