...
A [_generative program_](../reference/glossary.md#generative-program) is any program that contains calls to an LLM. This covers
...
The primary mechanism Mellea provides for managing stochasticity is [_requirements_](../reference/glossary.md#requirement).
...
feedback — the [_Instruct–Validate–Repair_ (IVR)](../reference/glossary.md#ivr-instruct-validate-repair) loop. This transforms a
...
Mellea's [sampling strategies](../reference/glossary.md#sampling-strategy) control how retries work:
...
- **[`SimpleContext`](../reference/glossary.md#context)** (default) resets history on each call. The model sees only
  the current instruction. This is usually the right choice for independent calls.
- **[`ChatContext`](../reference/glossary.md#context)** preserves history for multi-turn conversations.
- **[Components](../reference/glossary.md#component)** ([`@mify`](../reference/glossary.md#mify--mify), [`@generative`](../reference/glossary.md#generative)) encapsulate the context needed for a
