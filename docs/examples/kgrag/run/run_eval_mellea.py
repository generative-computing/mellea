#!/usr/bin/env python3
"""
Evaluation Script (Mellea-Native Implementation)

This script demonstrates evaluation using Mellea best practices:
- @generative decorator for LLM-based evaluation
- Pydantic models for type-safe outputs
- Requirements validation for robustness
- Component-based architecture
- Enhanced statistics tracking

Usage:
    python run_eval_mellea.py --reeval results/model_results.json
    python run_eval_mellea.py --result-path results/_results.json
    python run_eval_mellea.py --prefix exp1 --postfix test1 --verbose
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate QA results using Mellea-native patterns",
...
This Mellea-native version demonstrates:
  ✓ @generative decorator for evaluation
...
async def main() -> int:
    ...
    try:
        logger.info("=" * 60)
        logger.info("Mellea-Native Evaluation")
        logger.info("=" * 60)
        ...
        logger.info("  ✓ @generative decorator for evaluation")
        logger.info("  ✓ Type-safe Pydantic models")
        ...
        logger.info("")
        logger.info("=" * 60)
        logger.info("✅ Mellea-native evaluation completed!")
        logger.info("=" * 60)
