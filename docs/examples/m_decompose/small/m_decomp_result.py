...
assert shopping_list.value is not None, 'ERROR: task "shopping_list" execution failed'
...
assert party_timeline.value is not None, 'ERROR: task "party_timeline" execution failed'
