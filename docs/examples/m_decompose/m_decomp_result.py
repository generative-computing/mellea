...
assert event_schedule.value is not None, 'ERROR: task "event_schedule" execution failed'
...
assert team_formation.value is not None, 'ERROR: task "team_formation" execution failed'
...
assert catering_plan.value is not None, 'ERROR: task "catering_plan" execution failed'
...
assert prize_strategy.value is not None, 'ERROR: task "prize_strategy" execution failed'
