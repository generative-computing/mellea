...
sidebar_label: "mellea.backends.tools"
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `add_tools_from_context_actions` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/backends/tools.py#L363" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#add_tools_from_context_actions}

```python
add_tools_from_context_actions(tools_dict: dict[str, AbstractMelleaTool], ctx_actions: list[Component | CBlock | ModelOutputThunk] | None)
```
...
**Args:**
- `tools_dict`: Mutable mapping of tool name to tool instance; modified in-place.
- `ctx_actions`: List of [`Component`](../core/base#class-component), [`CBlock`](../core/base#class-cblock), or [`ModelOutputThunk`](../core/base#class-modeloutputthunk) objects whose template
representations may declare tools, or `None` to skip.


<div className="w-full h-px bg-gray-200 dark:bg-gray-700 my-4" />

### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `convert_tools_to_json` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/backends/tools.py#L389" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#convert_tools_to_json}
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `get_code_field_from_schema` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/backends/tools.py#L926" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#get_code_field_from_schema}
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `convert_function_to_ollama_tool` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/backends/tools.py#L1127" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#convert_function_to_ollama_tool}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `from_callable` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/backends/tools.py#L196" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#from_callable}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `from_callable` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/backends/tools.py#L201" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#from_callable}
