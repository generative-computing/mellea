...
sidebar_label: "mellea.plugins.manager"
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `drain_background_tasks` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/plugins/manager.py#L53" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#drain_background_tasks}
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `has_plugins` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/plugins/manager.py#L74" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#has_plugins}
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `shutdown_plugins` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/plugins/manager.py#L189" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#shutdown_plugins}
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `invoke_hook` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.7.0/mellea/plugins/manager.py#L235" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#invoke_hook}
