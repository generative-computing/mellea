...
- `model_output`: The [`ModelOutputThunk`](../../core/base#class-modeloutputthunk) at the time of the error.
- `generation_id`: Mellea-side hook correlation ID matching the
corresponding pre_call payload, distinct from the provider-assigned
`GenerationMetadata.response_id`. `None` when the firing site did
not generate one.
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#4ADE8033]/20 text-[#15803D]">CLASS</span> `GenerationEventPayload` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/plugins/hooks/generation.py#L91" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#class-generationeventpayload}
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#4ADE8033]/20 text-[#15803D]">CLASS</span> `GenerationBatchPostCallPayload` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/plugins/hooks/generation.py#L153" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#class-generationbatchpostcallpayload}
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#4ADE8033]/20 text-[#15803D]">CLASS</span> `GenerationBatchErrorPayload` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/plugins/hooks/generation.py#L178" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#class-generationbatcherrorpayload}
