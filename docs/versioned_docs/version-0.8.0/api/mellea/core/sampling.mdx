...
sidebar_label: "mellea.core.sampling"
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `result_action` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/core/sampling.py#L112" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#result_action}

```python
result_action(self) -> SampleActionType
```
...
**Args:**
- `action `: The action object to be sampled. A [`Component`](base#class-component), [`CBlock`](base#class-cblock), or [`ModelOutputThunk`](base#class-modeloutputthunk).
