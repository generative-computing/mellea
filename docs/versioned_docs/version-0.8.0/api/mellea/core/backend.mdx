...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `close` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/core/backend.py#L74" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#close}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `generate_from_raw` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/core/backend.py#L234" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#generate_from_raw}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `generate_from_raw` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/core/backend.py#L245" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#generate_from_raw}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `do_generate_walk` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/core/backend.py#L364" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#do_generate_walk}

```python
do_generate_walk(self, action: Span) -> None
```
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `do_generate_walks` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/core/backend.py#L382" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#do_generate_walks}

```python
do_generate_walks(self, actions: list[Span]) -> None
```
