...
Narrows the base `Context.new_instance()` return ([`Context`](../../core/base#class-context)) to `Self`, so
...
**Returns:**
- A fresh root context of the same concrete subtype with the same
...
**Returns:**
- A new context of the same concrete subtype carrying the same
