...
sidebar_label: "mellea.stdlib.components.mify"
...
Defaults to [`Query`](mobject#class-query).
- `transform_type`: A specific transform component type to use when
transforming with a model. Defaults to [`Transform`](mobject#class-transform).
...
**Returns:**
- A [`Query`](mobject#class-query) component wrapping this object and the given query.


<div className="w-full h-px bg-gray-200 dark:bg-gray-700 my-4" />

#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `get_transform_object` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/stdlib/components/mify.py#L70" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#get_transform_object}
...
**Returns:**
- A [`Transform`](mobject#class-transform) component wrapping this object and the
- given transformation description.


<div className="w-full h-px bg-gray-200 dark:bg-gray-700 my-4" />

#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `content_as_string` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/stdlib/components/mify.py#L84" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#content_as_string}
