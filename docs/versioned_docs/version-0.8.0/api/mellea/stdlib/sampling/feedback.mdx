...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `format_output_size_error` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/stdlib/sampling/feedback.py#L210" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#format_output_size_error}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `format_matplotlib_error` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/stdlib/sampling/feedback.py#L241" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#format_matplotlib_error}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `format_extraction_error` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/stdlib/sampling/feedback.py#L283" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#format_extraction_error}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `repair` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/stdlib/sampling/feedback.py#L369" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#repair}

```python
repair(old_ctx: Context, new_ctx: Context, past_actions: Sequence[SampleActionType], past_results: list[Any], past_val: list[list[tuple[Requirement, ValidationResult]]]) -> tuple[SampleActionType, Context]
```
