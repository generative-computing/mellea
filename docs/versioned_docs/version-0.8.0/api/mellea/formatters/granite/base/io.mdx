...
sidebar_label: "mellea.formatters.granite.base.io"
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `transform` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/formatters/granite/base/io.py#L27" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#transform}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `transform` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/formatters/granite/base/io.py#L60" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#transform}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `transform` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/formatters/granite/base/io.py#L88" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#transform}
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `transform` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.8.0/mellea/formatters/granite/base/io.py#L145" target="_blank"><Icon icon="github" style="width: 0.85em; height: 0.85em;" /></a></sup> {#transform}
...
**Returns:**
- list\[Document]: List of the top-k matching :class:[`Document`](../../../stdlib/components/docs/document#class-document) objects,
